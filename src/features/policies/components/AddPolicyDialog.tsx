 ...
 * 
 * Modal dialog for creating new policies with progressive disclosure.
 * Includes form validation, condition management, and intuitive UX.
 */
...
/**
 * Condition form component for individual policy conditions
 */
...
export function AddPolicyDialog({ open, onOpenChange }: AddPolicyDialogProps) {
  const { createPolicy, isLoading } = usePolicies();
  ...
  }, [formData, createPolicy, resetForm, onOpenChange]);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Set up a new worm distribution policy with custom conditions and rewards.
          </DialogDescription>
        </DialogHeader>
        ...
        {currentStep === 'review' && (
          <div className="flex flex-col gap-6">
            <div>
              <h3 className="text-lg font-medium mb-4">Review Policy</h3>
              <div className="flex flex-col gap-4">
                <Card>
                  <CardHeader>
